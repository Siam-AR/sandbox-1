      ...
      <div class="flex gap-2 flex-wrap mb-4">
          ${issue.labels
            .map((label) => {
              ...
              return `
              <span class="flex items-center gap-0.25 text-[9px] px-1 py-[1px] rounded-full border ${style.border} ${style.text} ${style.bg}">
              ${style.iconImg ? `<img src="${style.iconImg}" class="w-2 h-2">` : style.iconFA}
              ${label.toUpperCase()}
              </span>
          `;
            })
